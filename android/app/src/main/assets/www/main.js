...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, fb, authSvc) {
...
/* harmony import */ var _services_database_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/database.service */ "./src/app/services/database.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                _services_auth_service__WEBPACK_IMPORTED_MODULE_0__["AuthService"],
                _services_database_service__WEBPACK_IMPORTED_MODULE_14__["DatabaseService"]
            ],
...
var DatabaseService = /** @class */ (function () {
    function DatabaseService(afs) {
        ...
        var DATE = pipe.transform(date, 'dd-MM-yyyy');
        this.AttendancetCollection = this.afs.collection(DATE);
        this.batch = this.batchCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) { return actions.map(function (a) {
            var data = a.payload.doc.data();
            var $key = a.payload.doc.id;
            return __assign({ $key: $key }, data);
        }); }));
        this.student = this.studentCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) { return actions.map(function (a) {
            var data = a.payload.doc.data();
            var $key = a.payload.doc.id;
            return __assign({ $key: $key }, data);
        }); }));
        this.attendance = this.AttendancetCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) { return actions.map(function (a) {
            var data = a.payload.doc.data();
            var $key = a.payload.doc.id;
            return __assign({ $key: $key }, data);
        }); }));
    ...
    //Batch
    DatabaseService.prototype.getBatch = function () {
        return this.batch;
    };
    //student
    DatabaseService.prototype.getStudent = function (batchId) {
        this.studentCollection = this.afs.collection('student', function (ref) { return ref.where('batch_id', '==', batchId); });
        this.student = this.studentCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) { return actions.map(function (a) {
            var data = a.payload.doc.data();
            var $key = a.payload.doc.id;
            return __assign({ $key: $key }, data);
    ...
    // }
    DatabaseService.prototype.getAttendance = function () {
        return this.attendance;
    };
    DatabaseService.prototype.addAttendance = function (stud) {
...
module.exports = __webpack_require__(/*! /home/alrashid4star/Documents/Workouts/IonicProjects/DBMS/src/main.ts */"./src/main.ts");
